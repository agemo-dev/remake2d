...
The main loop is the heart of any graphical application. It continuously runs the game logic and rendering code until a stop condition is met, allowing your application to stay responsive.
...
Now, the base code for every game/app built with this engine will look like this:
