...
Signal<> onFinish; // emit when sound ended (in last remaining)
...
Signal<> onRepeat; // emit when animation remaining
Signal<> onFinish; // emit when animation ended (in last remaining)
```
