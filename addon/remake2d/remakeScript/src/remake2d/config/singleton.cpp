...
void initLuaSingleton(sol::table& rmk) noexcept {
    ...
    script._registerEngineType<System::Toggle>("System::Toggle", [](SolState::Type& ut) {
    ...
    script._registerEngineType<System::Setup>("System::Setup", [](SolState::Type& ut) {
        ...
        ut["mobileOrientation"] = [](rmk::System::Setup& self, std::vector<std::string_view> views) {
